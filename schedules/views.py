...
from .helpers import get_shifts_to_add, get_week_schedule_view_info, get_ratio_table, get_ratio_tables_in_window, get_stapher_breakdown_table, get_time_from_string, get_all_staphers_qualifications_csv
...
class DownloadView(LoginRequiredMixin, TemplateView):
	...
	def get_context_data(self, *args, **kwargs):
		...
		context['stapher_qual_csv'] = get_all_staphers_qualifications_csv()
		return context
