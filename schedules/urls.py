...
urlpatterns = [
    ...
    url(r'^schedules/duplicate/(?P<id>[\d]+)/$', views.schedule_duplicate, name='duplicate'),
    url(r'^schedules/duplicate/(?P<pk>[\d]+)/confirm$', views.schedule_duplicate_confirmation, name='duplicate-confirmation'),
    ...
    url(r'^shifts/(?P<pk>[\d]+)/schedule$', views.shift_schedule, name='shift-schedule'),
    url(r'^shifts/(?P<sh>[\d]+)/schedule/(?P<st>[\d]+)$', views.shift_schedule_stapher, name='shift-schedule-stapher'),
    ...
    url(r'^set/add/(?P<pk>[\d]+)$', views.shift_set_add, name='set-select-set'),
