...
urlpatterns = [
    ...
    url(r'^staphers/(?P<pk>[\d]+)/schedule/$', views.stapher_schedule_view(False), name='stapher-schedule'),
    url(r'^staphers/(?P<pk>[\d]+)/schedule/add$', views.stapher_schedule_add, name='stapher-schedule-shift'),
